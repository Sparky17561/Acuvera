...
External services: PostgreSQL only (+ optional Clerk JWT, GROQ).
"""
import os
...
DATABASE_URL = config("DATABASE_URL", default=f"postgresql://postgres:abc123@localhost:5432/acuvera_db")
DATABASES = {
